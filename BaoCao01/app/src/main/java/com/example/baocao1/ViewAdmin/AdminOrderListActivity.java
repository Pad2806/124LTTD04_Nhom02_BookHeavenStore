...
import com.example.baocao1.View.FragmentPageAdapter;
...
public class AdminOrderListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_donhang_admin1);
        ...
        icon_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AdminOrderListActivity.this, AdminActivity.class));
            }
        });
    }
}