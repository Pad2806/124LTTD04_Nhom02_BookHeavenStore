...
public class TheLoaiSachAdapter extends RecyclerView.Adapter<TheLoaiSachAdapter.NoiBatViewHolder> {
    private List<ChiTietSach> dsSach;
    private static OnItemClickListener onItemClickListener;
    public interface OnItemClickListener {
        void onItemClickTheLoaiSach(View view, int position, long id);
    }
    public TheLoaiSachAdapter(List<ChiTietSach> dsSach, OnItemClickListener onItemClickListener) {
        this.dsSach = dsSach;
    ...
    public void onBindViewHolder(@NonNull NoiBatViewHolder holder, int position) {
        ChiTietSach sanPham = dsSach.get(position);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onItemClickListener != null) {
                        onItemClickListener.onItemClickTheLoaiSach(v, getAdapterPosition(), getItemId());
                    }
                }
            });
        }
